...
const DICT: Dict = {
  ...
  "how.s1.t": { fr: "Choisissez", en: "Choose" },
  "how.s1.d": { fr: "Parcourez le catalogue et sélectionnez vos objets.", en: "Browse the catalog and select your items." },
  "how.s2.t": { fr: "Configurez", en: "Configure" },
  "how.s2.d": { fr: "Personnalisez chaque pièce dans le configurateur 3D.", en: "Customize each piece in the 3D configurator." },
  "how.s3.t": { fr: "Demandez votre devis", en: "Request your quote" },
  "how.s3.d": { fr: "Constituez votre devis simulé et envoyez votre demande.", en: "Build your simulated quote and submit your request." },
  "how.s4.t": { fr: "Validation commerciale", en: "Sales validation" },
  "how.s4.d": { fr: "Notre équipe vous recontacte sous 24h pour finaliser.", en: "Our team contacts you within 24h to finalize." },
